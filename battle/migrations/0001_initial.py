    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_pos', models.IntegerField()),
                ('z_pos', models.IntegerField()),
                ('battle_character_in_turn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='battle.BattleCharacterInTurn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('what', models.CharField(choices=[('stand', 'stand'), ('move', 'move'), ('flee', 'flee'), ('charge', 'charge'), ('formation', 'formation'), ('ranged', 'ranged')], max_length=15)),
