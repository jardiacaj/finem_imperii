...
class NPC(models.Model):
    ...
    origin = models.ForeignKey('world.Settlement', related_name='offspring')
    residence = models.ForeignKey(
        'world.Building', null=True, blank=True, related_name='resident'
    )
    location = models.ForeignKey('world.Settlement', null=True, blank=True)
    workplace = models.ForeignKey(
        'world.Building', null=True, blank=True, related_name='worker'
    )
